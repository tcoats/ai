...
define(['inject', 'p2'], function(inject, p2) {
  ...
  Physics = (function() {
    function Physics() {
      ...
      this.calculateperpendicular2 = __bind(this.calculateperpendicular2, this);
      this.anticlockwise = __bind(this.anticlockwise, this);
      this.calculateperpendicular = __bind(this.calculateperpendicular, this);
      ...
      inject.bind('calculate perpendicular', this.calculateperpendicular);
      inject.bind('calculate perpendicular 2', this.calculateperpendicular2);
      inject.bind('anticlockwise', this.anticlockwise);
    }
    ...
    Physics.prototype.calculateperpendicular = function(from, to, point) {
    ...
    Physics.prototype.anticlockwise = function(vec) {
      return [-vec[1], vec[0]];
    };

    Physics.prototype.calculateperpendicular2 = function(from, to, point) {
      var calc, lambda, unit;
      unit = [0, 0];
      p2.vec2.sub(unit, to, from);
      p2.vec2.normalize(unit, unit);
      unit = this.anticlockwise(unit);
      calc = [0, 0];
      p2.vec2.sub(calc, point, from);
      lambda = p2.vec2.dot(unit, calc);
      p2.vec2.scale(calc, unit, lambda);
